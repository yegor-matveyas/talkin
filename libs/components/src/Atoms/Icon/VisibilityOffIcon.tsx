...
export default function VisibilityOffIcon({ className = '', style = {} }: ComponentDefaultProps) {
  return (
    <svg
      width="36"
      height="36"
    ...
    >
      <g clipPath="url(#clip0_110_10)">
        ...
        <path
          ...
          fill="currentColor"
        />
        <rect x="5" y="7.82843" width="4" height="32" rx="2" transform="rotate(-45 5 7.82843)" fill="currentColor" />
      </g>
    </svg>
  )
}
